...
const roles = [
  ...
  { value: 'dispatcher', label: 'Диспетчер поездов', icon: 'Radio' },
  { value: 'station-duty', label: 'Дежурный по станции', icon: 'Clock' },
  { value: 'track-worker', label: 'Путевой рабочий', icon: 'Wrench' },
  { value: 'electrician', label: 'Электромонтёр контактной сети', icon: 'Zap' },
  { value: 'train-assembler', label: 'Составитель поездов', icon: 'Settings' },
  { value: 'inspector', label: 'Ревизор', icon: 'Search' },
  { value: 'farmer', label: 'Фермер', icon: 'Wheat' },
  { value: 'miner', label: 'Шахтёр', icon: 'Pickaxe' },
  { value: 'engineer', label: 'Инженер', icon: 'Cog' },
